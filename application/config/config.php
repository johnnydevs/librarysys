 ...
 */
define('URL', 'http://localhost/logintest/');

define('LOGO', 'public/img/logo.png');
...
define('COOKIE_DOMAIN', '.localhost/logintest');
...
define("FEEDBACK_BOOK_ADD_FAILED", "Book add failed.");
define("FEEDBACK_BOOK_RESERVE_SUCCESSFUL", "Book reservation successful.");
define("FEEDBACK_BOOK_RESERVE_UNSUCCESSFUL", "Book reservation failed.");
define("FEEDBACK_ADDED_TO_FAVS", "Book added to favourites.");
define("FEEDBACK_REMOVED_FROM_FAVS", "Book removed from favourites.");
define("FEEDBACK_REMOVED_FROM_FAVS_FAIL", "Unable to remove book from favourites.");
define("FEEDBACK_BOOK_SET_AVAILABLE_SUCCESS", "Book marked as available.");
define("FEEDBACK_BOOK_SET_AVAILABLE_FAIL", "Unable to mark book as available.");
define("FEEDBACK_BOOK_SET_UNAVAILABLE_SUCCESS", "Book marked as unavailable.");
define("FEEDBACK_BOOK_SET_UNAVAILABLE_FAIL", "Unable to mark book as unavailable.");
define("FEEDBACK_BOOK_ARCHIVE_SUCCESS", "Book successfully archived.");
define("FEEDBACK_BOOK_ARCHIVE_FAIL", "Unable to archive book.");
define("FEEDBACK_BOOK_BIN_SUCCESS", "Book successfully sent to bin.");
